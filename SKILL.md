...
- 默认段间距为 40px，36px 正文的段内行间距为 22px（总行高 58px）；正文四边安全边距统一为 72px。一级标题下方引线保持原样，位于画布 174px；横线纸/方格纸以 58px 的第三行/格对齐引线，蓝图格以 43.5px 的第四格对齐引线。二级标题为 36px 正文规格的强调色下划线，页首前留 44px、后留 40px。
